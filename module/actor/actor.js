 ...
 * @extends {Actor}
 */
export class ScornActor extends Actor {
  /** @override */
  ...
  _prepareCharacterData() {
    ...
    this.system.maxSlots = this.calcMaxSlots();
    this.system.encumbered = this.system.slotsUsed >= this.system.maxSlots;
  ...
  deleteOwnedItem(itemId) {
    ...
    if (item) {
      ...
      ui.notifications.error(game.i18n.localize("SCORN.NoItemToDelete"));
    }
  }
  ...
  calcMaxSlots() {
    return Math.max(10, this.system.abilities.STR.max);
  }
